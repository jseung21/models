...
from asb_utils import set_log, check_time
...
def user_input():
    ...
    config.add_argument('-i','--input_folder',help='Input Images Forlder',default='./asb_data/',type=str, required=False)
    ...
    config.add_argument('-tc', '--train_csv_output', help='Train csv output file Location', default='./asb_dataset/train.csv', type=str,required=False)
    config.add_argument('-vc', '--validate_csv_output', help='Validate csv output file Location', default='./asb_dataset/validate.csv', type=str,required=False)
...
def main():
    ...
    writer = tf.python_io.TFRecordWriter('./asb_dataset/train.record')
    ...
    writer = tf.python_io.TFRecordWriter('./asb_dataset/validate.record')
    for group in grouped:
        tf_example = create_tf_example(group, args['input_folder'])
        writer.write(tf_example.SerializeToString())
